            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">Mitra Penjualan</h1>
        ...
        <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <form method="post">
                        <div class="mb-3">
                            <label for="jenis_mitra" class="col-form-label">Jenis Mitra:</label>
                            <select name="jenis_mitra" id="jenis_mitra" class="form-select mb-3" required>
                                <option value="">Pilih Jenis Mitra Penjualan</option>
                        ...
                        <div class="mb-3">
                            <label for="kode_mitra" class="col-form-label">Kode Mitra:</label>
                            <input type="text" name="kode_mitra" class="form-control" id="kode_mitra">
                        </div>
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="tel" name="notelp" class="form-control" id="notelp" maxlength="13" placeholder="08*********">
                        </div>
                        <div class="mb-3">
                            <label for="email_mitra" class="form-label">Email</label>
                            <input type="email" name="email_mitra" class="form-control" id="email_mitra">
                        </div>
