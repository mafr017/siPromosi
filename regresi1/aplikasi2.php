...
<script>
$.getJSON('ambildata.php', function(hasil) {
	console.log(hasil);
	var regresi = hasil.regresi;
	console.log(regresi);
	var nuevo = regresi.map((i) => Number(i));
	console.log(nuevo);
	// regresi.forEach((entry) => {
	// 	console.log(entry['x1'], entry['x2']);
	// });
		// console.log(data);
		$('#rs').handsontable({
 data :regresi,
...
//gimana caranya biar si array regresi ini bisa dipanggil
...
// 			// 	var dataregresi = dataregresi.html("val.x1+val.x2");
// 			// 	var data=$("rs");
// 			// 	data.append(dataregresi);
// 			// })
// 			var data = [
// 				[[x1], [x2]]
// 			]
